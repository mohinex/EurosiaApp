    ...
    <div className="bg-white font-sans text-gray-900 min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 bg-gray-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto text-center">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-100 rounded-full text-[#B91C1C] text-xs font-black uppercase tracking-[0.2em] mb-8"
          >
            <Layers size={14} fill="currentColor" />
            <span>App Marketplace</span>
          </motion.div>
          <h1 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter">Scale Your <span className="text-[#B91C1C]">Ecosystem</span></h1>
          ...
          <div className="mt-12 max-w-2xl mx-auto relative group">
             <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#B91C1C] transition-colors" size={24} />
             <input 
               type="text" 
               placeholder="Search apps, modules, or plugins..." 
               className="w-full bg-white border border-gray-200 rounded-[32px] pl-16 pr-8 py-6 text-lg font-bold outline-none focus:ring-4 focus:ring-[#B91C1C]/10 transition-all shadow-xl shadow-black/5"
             />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <aside className="w-full lg:w-64 space-y-10 shrink-0">
                  ...
                  <div className="space-y-3">
                    {categories.map((cat) => (
                      <button key={cat} className={`block w-full text-left px-4 py-3 rounded-2xl text-sm font-black transition-all ${
                        cat === "All" ? "bg-[#B91C1C] text-white shadow-lg" : "text-gray-500 hover:bg-gray-50"
                      }`}>
                        {cat}
                      </button>
                    ))}
               ...
               <div className="p-6 bg-red-50 rounded-3xl border border-red-100">
                  <Zap className="text-[#B91C1C] mb-4" size={32} fill="currentColor" />
                  ...
                  <Link to="/developer" className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-[#B91C1C]">
                    Developer Docs
                    <ArrowRight size={14} />
                  </Link>
               </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 {apps.map((app, i) => (
                   <motion.div 
                     ...
                     className="bg-white p-8 rounded-[40px] border border-gray-100 hover:shadow-2xl hover:border-gray-200 transition-all group flex flex-col"
                   >
                     ...
                     <div className="mt-auto pt-8 border-t border-gray-50 flex items-center justify-between">
                        ...
                        <button className="flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-[#B91C1C] transition-colors">
                           <Download size={16} />
                           Integrate
                        </button>
                     </div>
                 ...
                 {/* Coming Soon Card */}
                 <div className="bg-[#B91C1C] p-8 rounded-[40px] text-white flex flex-col justify-center items-center text-center relative overflow-hidden group border-4 border-white/10 shadow-2xl">
                    ...
                    <button className="bg-white text-[#B91C1C] px-8 py-4 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-gray-100 transition-colors shadow-xl">
                      Developer Program
                    </button>
                 </div>
              </div>
      ...
      <section className="py-24 bg-gray-900 text-white">
         <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-6xl font-black mb-8 tracking-tighter">Unified Core. Infinite <span className="text-[#B91C1C]">Possibilities.</span></h2>
